...
local function touchBall( event )
 ...
 local function touchBanana( event )
         if event.phase == "began" then
            ...
            textpuntuacio.text = "puntuacio:"..puntuacio
            sonidoPlatano()
...
function scene:create( event )
    ...
    numero = display.newText(sceneGroup, "", 120, 50, native.systemFont, 50 )
    numero:setFillColor( 0,0,0 )

    --puntuacio
    textpuntuacio = display.newText( sceneGroup, "", _W-150, 50, native.systemFont, 50 )
    textpuntuacio:setFillColor( 0,0,0 )
